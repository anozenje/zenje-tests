describe ("The mostProfitableDepartment function test status :", function() {
    it("The mostProfitableDepartment loops through the objects & computes to return the most profitable Departments", function () {
        var salesData = [
    ...
    it("The mostProfitableDepartment loops through the objects & computes to return the most profitable Days", function() {
        var salesData = [
            {department : 'hardware', sales : 4500, day : 'Monday'},
            {department : 'outdoor', sales : 1500, day : 'Monday'},
            {department : 'carpentry', sales : 5500, day : 'Monday'},
